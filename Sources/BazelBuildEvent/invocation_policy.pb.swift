...
public struct Blaze_InvocationPolicy_InvocationPolicy: Sendable {
  ...
  public var strategyPolicy: Blaze_StrategyPolicy_StrategyPolicy {
    get {return _strategyPolicy ?? Blaze_StrategyPolicy_StrategyPolicy()}
    set {_strategyPolicy = newValue}
  }
  /// Returns true if `strategyPolicy` has been explicitly set.
  public var hasStrategyPolicy: Bool {return self._strategyPolicy != nil}
  /// Clears the value of `strategyPolicy`. Subsequent reads from it will return its default value.
  public mutating func clearStrategyPolicy() {self._strategyPolicy = nil}

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _strategyPolicy: Blaze_StrategyPolicy_StrategyPolicy? = nil
}

/// A policy for controlling the value of a flag.
public struct Blaze_InvocationPolicy_FlagPolicy: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Blaze_InvocationPolicy_SetValue: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum Behavior: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
    case undefined = 0
...
public struct Blaze_InvocationPolicy_UseDefault: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Blaze_InvocationPolicy_DisallowValues: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum OneOf_ReplacementValue: Equatable, Sendable {
    /// If set and if the value of the flag is disallowed (including the default
    /// value of the flag if the user doesn't specify a value), use this value as
    /// the value of the flag instead of raising an error. This does not apply to
    /// repeatable flags and is ignored if the flag is a repeatable flag.
...
public struct Blaze_InvocationPolicy_AllowValues: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Blaze_InvocationPolicy_InvocationPolicy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .standard(proto: "strategy_policy"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._strategyPolicy) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._strategyPolicy {
  ...
  public static func ==(lhs: Blaze_InvocationPolicy_InvocationPolicy, rhs: Blaze_InvocationPolicy_InvocationPolicy) -> Bool {
    ...
    if lhs._strategyPolicy != rhs._strategyPolicy {return false}
