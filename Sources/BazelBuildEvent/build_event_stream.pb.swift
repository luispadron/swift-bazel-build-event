...
/// test rule.
public enum BuildEventStream_TestSize: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [BuildEventStream_TestSize] = [
    .unknown,
    .small,
    .medium,
    .large,
...
public enum BuildEventStream_TestStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case noStatus // = 0
  case passed // = 1
  case flaky // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [BuildEventStream_TestStatus] = [
    .noStatus,
    .passed,
    .flaky,
    .timeout,
...
public struct BuildEventStream_BuildEventId: Sendable {
  ...
  public struct UnknownBuildEventId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct ProgressId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct BuildStartedId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  /// the bazel server.
  public struct UnstructuredCommandLineId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct StructuredCommandLineId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct WorkspaceStatusId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct OptionsParsedId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  /// from.
  public struct FetchId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct PatternExpandedId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct WorkspaceConfigId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct BuildMetadataId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct TargetConfiguredId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct NamedSetOfFilesId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct ConfigurationId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct TargetCompletedId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct ActionCompletedId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct UnconfiguredLabelId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct ConfiguredLabelId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  /// starting with 1.
  public struct TestResultId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct TestProgressId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct TestSummaryId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct TargetSummaryId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct BuildFinishedId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct BuildToolLogsId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  /// of the build.
  public struct BuildMetricsId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct ConvenienceSymlinksIdentifiedId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct ExecRequestId: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
public struct BuildEventStream_Progress: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_Aborted: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum AbortReason: SwiftProtobuf.Enum, Swift.CaseIterable {
    public typealias RawValue = Int
    case unknown // = 0
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [BuildEventStream_Aborted.AbortReason] = [
      .unknown,
      .userInterrupted,
      .noAnalyze,
      .noBuild,
...
/// target pattern.
public struct BuildEventStream_BuildStarted: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_WorkspaceConfig: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// invocation.
public struct BuildEventStream_UnstructuredCommandLine: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_OptionsParsed: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_Fetch: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// space).
public struct BuildEventStream_WorkspaceStatus: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// build.
public struct BuildEventStream_BuildMetadata: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_Configuration: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_PatternExpanded: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public struct TestSuiteExpansion: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
public struct BuildEventStream_TargetConfigured: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_File: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_NamedSetOfFiles: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_ActionExecuted: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_OutputGroup: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var inlineFiles: [BuildEventStream_File] = []
...
/// children events.
public struct BuildEventStream_TargetComplete: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_TestResult: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_TestProgress: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_TestSummary: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_TargetSummary: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_BuildFinished: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public struct ExitCode: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct AnomalyReport: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
public struct BuildEventStream_BuildMetrics: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var dynamicExecutionMetrics: BuildEventStream_BuildMetrics.DynamicExecutionMetrics {
    get {return _storage._dynamicExecutionMetrics ?? BuildEventStream_BuildMetrics.DynamicExecutionMetrics()}
    set {_uniqueStorage()._dynamicExecutionMetrics = newValue}
  }
  /// Returns true if `dynamicExecutionMetrics` has been explicitly set.
  public var hasDynamicExecutionMetrics: Bool {return _storage._dynamicExecutionMetrics != nil}
  /// Clears the value of `dynamicExecutionMetrics`. Subsequent reads from it will return its default value.
  public mutating func clearDynamicExecutionMetrics() {_uniqueStorage()._dynamicExecutionMetrics = nil}

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public struct ActionSummary: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public struct ActionData: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
    ...
    public struct RunnerCount: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
  ...
  public struct MemoryMetrics: Sendable {
    ...
    public struct GarbageMetrics: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
  ...
  public struct PackageMetrics: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct TimingMetrics: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var actionsExecutionStartInMs: Int64 = 0
  ...
  public struct CumulativeMetrics: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct ArtifactMetrics: Sendable {
    ...
    public struct FilesMetric: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
  ...
  public struct EvaluationStat: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// Name of the Skyfunction.
    public var skyfunctionName: String = String()
  ...
  public struct BuildGraphMetrics: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var dirtiedValues: [BuildEventStream_BuildMetrics.EvaluationStat] = []
    ...
    public var changedValues: [BuildEventStream_BuildMetrics.EvaluationStat] = []
    ...
    public var builtValues: [BuildEventStream_BuildMetrics.EvaluationStat] = []

    /// Number of SkyValues that were evaluated and found clean, i.e. equal to
    /// their previous version.
    public var cleanedValues: [BuildEventStream_BuildMetrics.EvaluationStat] = []
    ...
    public var evaluatedValues: [BuildEventStream_BuildMetrics.EvaluationStat] = []

    public var ruleClass: [BuildEventStream_BuildMetrics.BuildGraphMetrics.RuleClassCount] = []

    public var aspect: [BuildEventStream_BuildMetrics.BuildGraphMetrics.AspectCount] = []
    ...
    public struct RuleClassCount: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
      ...
      public var ruleClass: String = String()
  ...
  public struct WorkerMetrics: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var workerStatus: BuildEventStream_BuildMetrics.WorkerMetrics.WorkerStatus = .notStarted

    public var code: FailureDetails_Worker.Code {
      get {return _code ?? .workerUnknown}
      set {_code = newValue}
    }
    ...
    public var priorActionsExecuted: Int64 = 0
    ...
    public enum WorkerStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
      ...
      case notStarted // = 0
      case alive // = 1
      case killedDueToMemoryPressure // = 2
      ...
      case killedUnknown // = 3
      case killedDueToInterruptedException // = 4
      case killedDueToIoException // = 5
      case killedDueToUserExecException // = 6
      case UNRECOGNIZED(Int)
      ...
      public init?(rawValue: Int) {
        ...
        case 1: self = .alive
        case 2: self = .killedDueToMemoryPressure
        case 3: self = .killedUnknown
        case 4: self = .killedDueToInterruptedException
        case 5: self = .killedDueToIoException
        case 6: self = .killedDueToUserExecException
        default: self = .UNRECOGNIZED(rawValue)
        }
      }
      ...
      public var rawValue: Int {
        ...
        case .alive: return 1
        case .killedDueToMemoryPressure: return 2
        case .killedUnknown: return 3
        case .killedDueToInterruptedException: return 4
        case .killedDueToIoException: return 5
        case .killedDueToUserExecException: return 6
        case .UNRECOGNIZED(let i): return i
        }
      }

      // The compiler won't synthesize support with the UNRECOGNIZED case.
      public static let allCases: [BuildEventStream_BuildMetrics.WorkerMetrics.WorkerStatus] = [
        .notStarted,
        .alive,
        .killedDueToMemoryPressure,
        .killedUnknown,
        .killedDueToInterruptedException,
        .killedDueToIoException,
        .killedDueToUserExecException,
      ]
    ...
    public struct WorkerStats: Sendable {
      ...
      public var priorWorkerMemoryInKb: Int32 = 0
    ...
    fileprivate var _code: FailureDetails_Worker.Code? = nil
  }
  ...
  public struct NetworkMetrics: Sendable {
    ...
    public struct SystemNetworkStats: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
  ...
  public struct WorkerPoolMetrics: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public struct WorkerPoolStats: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
      ...
      public var userExecExceptionDestroyedCount: Int64 = 0

      /// Number of workers destroyed due to IoExceptions.
      public var ioExceptionDestroyedCount: Int64 = 0

      /// Number of workers destroyed due to InterruptedExceptions.
      public var interruptedExceptionDestroyedCount: Int64 = 0

      /// Number of workers destroyed due to an unknown reason.
      public var unknownDestroyedCount: Int64 = 0

      /// Number of workers alive at the end of the build.
      public var aliveCount: Int64 = 0
  ...
  public struct DynamicExecutionMetrics: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// Race statistics grouped by mnemonic, local_name, remote_name.
    public var raceStatistics: [BuildEventStream_BuildMetrics.DynamicExecutionMetrics.RaceStatistics] = []
    ...
    public struct RaceStatistics: Sendable {
      ...
      public var localRunner: String = String()

      /// Name of runner of remote branch.
      public var remoteRunner: String = String()

      /// Number of wins of local branch in race.
      public var localWins: Int32 = 0

      /// Number of wins of remote branch in race.
      public var remoteWins: Int32 = 0
...
public struct BuildEventStream_BuildToolLogs: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_ConvenienceSymlinksIdentified: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// target of a symlink.
public struct BuildEventStream_ConvenienceSymlink: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum Action: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [BuildEventStream_ConvenienceSymlink.Action] = [
      .unknown,
      .create,
      .delete,
    ]
...
public struct BuildEventStream_ExecRequestConstructed: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_EnvironmentVariable: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuildEventStream_BuildEvent: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension BuildEventStream_OutputGroup: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeRepeatedMessageField(value: &self.inlineFiles) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.inlineFiles.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.inlineFiles, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: BuildEventStream_OutputGroup, rhs: BuildEventStream_OutputGroup) -> Bool {
    ...
    if lhs.inlineFiles != rhs.inlineFiles {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension BuildEventStream_BuildMetrics: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    12: .standard(proto: "dynamic_execution_metrics"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _dynamicExecutionMetrics: BuildEventStream_BuildMetrics.DynamicExecutionMetrics? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _dynamicExecutionMetrics = source._dynamicExecutionMetrics
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 12: try { try decoder.decodeSingularMessageField(value: &_storage._dynamicExecutionMetrics) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._dynamicExecutionMetrics {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 12)
      } }()
    }
    try unknownFields.traverse(visitor: &visitor)
  ...
  public static func ==(lhs: BuildEventStream_BuildMetrics, rhs: BuildEventStream_BuildMetrics) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._dynamicExecutionMetrics != rhs_storage._dynamicExecutionMetrics {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension BuildEventStream_BuildMetrics.ActionSummary.ActionData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    7: .standard(proto: "actions_created"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 7: try { try decoder.decodeSingularInt64Field(value: &self.actionsCreated) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.actionsCreated != 0 {
      try visitor.visitSingularInt64Field(value: self.actionsCreated, fieldNumber: 7)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension BuildEventStream_BuildMetrics.TimingMetrics: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    5: .standard(proto: "actions_execution_start_in_ms"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularInt64Field(value: &self.actionsExecutionStartInMs) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.actionsExecutionStartInMs != 0 {
      try visitor.visitSingularInt64Field(value: self.actionsExecutionStartInMs, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: BuildEventStream_BuildMetrics.TimingMetrics, rhs: BuildEventStream_BuildMetrics.TimingMetrics) -> Bool {
    ...
    if lhs.actionsExecutionStartInMs != rhs.actionsExecutionStartInMs {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension BuildEventStream_BuildMetrics.EvaluationStat: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = BuildEventStream_BuildMetrics.protoMessageName + ".EvaluationStat"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "skyfunction_name"),
    2: .same(proto: "count"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.skyfunctionName) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.skyfunctionName.isEmpty {
      try visitor.visitSingularStringField(value: self.skyfunctionName, fieldNumber: 1)
    }
    if self.count != 0 {
  ...
  public static func ==(lhs: BuildEventStream_BuildMetrics.EvaluationStat, rhs: BuildEventStream_BuildMetrics.EvaluationStat) -> Bool {
    if lhs.skyfunctionName != rhs.skyfunctionName {return false}
    if lhs.count != rhs.count {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension BuildEventStream_BuildMetrics.BuildGraphMetrics: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    10: .standard(proto: "dirtied_values"),
    11: .standard(proto: "changed_values"),
    12: .standard(proto: "built_values"),
    13: .standard(proto: "cleaned_values"),
    17: .standard(proto: "evaluated_values"),
    14: .standard(proto: "rule_class"),
    15: .same(proto: "aspect"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 10: try { try decoder.decodeRepeatedMessageField(value: &self.dirtiedValues) }()
      case 11: try { try decoder.decodeRepeatedMessageField(value: &self.changedValues) }()
      case 12: try { try decoder.decodeRepeatedMessageField(value: &self.builtValues) }()
      case 13: try { try decoder.decodeRepeatedMessageField(value: &self.cleanedValues) }()
      case 14: try { try decoder.decodeRepeatedMessageField(value: &self.ruleClass) }()
      case 15: try { try decoder.decodeRepeatedMessageField(value: &self.aspect) }()
      case 17: try { try decoder.decodeRepeatedMessageField(value: &self.evaluatedValues) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.dirtiedValues.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.dirtiedValues, fieldNumber: 10)
    }
    if !self.changedValues.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.changedValues, fieldNumber: 11)
    }
    if !self.builtValues.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.builtValues, fieldNumber: 12)
    }
    if !self.cleanedValues.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.cleanedValues, fieldNumber: 13)
    }
    if !self.ruleClass.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.ruleClass, fieldNumber: 14)
    }
    if !self.aspect.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.aspect, fieldNumber: 15)
    }
    if !self.evaluatedValues.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.evaluatedValues, fieldNumber: 17)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: BuildEventStream_BuildMetrics.BuildGraphMetrics, rhs: BuildEventStream_BuildMetrics.BuildGraphMetrics) -> Bool {
    ...
    if lhs.dirtiedValues != rhs.dirtiedValues {return false}
    if lhs.changedValues != rhs.changedValues {return false}
    if lhs.builtValues != rhs.builtValues {return false}
    if lhs.cleanedValues != rhs.cleanedValues {return false}
    if lhs.evaluatedValues != rhs.evaluatedValues {return false}
    if lhs.ruleClass != rhs.ruleClass {return false}
    if lhs.aspect != rhs.aspect {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension BuildEventStream_BuildMetrics.BuildGraphMetrics.RuleClassCount: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = BuildEventStream_BuildMetrics.BuildGraphMetrics.protoMessageName + ".RuleClassCount"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "key"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.key) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.ruleClass) }()
      case 3: try { try decoder.decodeSingularUInt64Field(value: &self.count) }()
      case 4: try { try decoder.decodeSingularUInt64Field(value: &self.actionCount) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.ruleClass.isEmpty {
      try visitor.visitSingularStringField(value: self.ruleClass, fieldNumber: 2)
    }
    if self.count != 0 {
      try visitor.visitSingularUInt64Field(value: self.count, fieldNumber: 3)
    }
    if self.actionCount != 0 {
      try visitor.visitSingularUInt64Field(value: self.actionCount, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: BuildEventStream_BuildMetrics.BuildGraphMetrics.RuleClassCount, rhs: BuildEventStream_BuildMetrics.BuildGraphMetrics.RuleClassCount) -> Bool {
    if lhs.key != rhs.key {return false}
    if lhs.ruleClass != rhs.ruleClass {return false}
    if lhs.count != rhs.count {return false}
    if lhs.actionCount != rhs.actionCount {return false}
...
extension BuildEventStream_BuildMetrics.BuildGraphMetrics.AspectCount: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = BuildEventStream_BuildMetrics.BuildGraphMetrics.protoMessageName + ".AspectCount"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "key"),
    2: .standard(proto: "aspect_name"),
    3: .same(proto: "count"),
    4: .standard(proto: "action_count"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.key) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.aspectName) }()
      case 3: try { try decoder.decodeSingularUInt64Field(value: &self.count) }()
      case 4: try { try decoder.decodeSingularUInt64Field(value: &self.actionCount) }()
      default: break
      }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.aspectName.isEmpty {
      try visitor.visitSingularStringField(value: self.aspectName, fieldNumber: 2)
    }
    if self.count != 0 {
      try visitor.visitSingularUInt64Field(value: self.count, fieldNumber: 3)
    }
  ...
  public static func ==(lhs: BuildEventStream_BuildMetrics.BuildGraphMetrics.AspectCount, rhs: BuildEventStream_BuildMetrics.BuildGraphMetrics.AspectCount) -> Bool {
    if lhs.key != rhs.key {return false}
...
extension BuildEventStream_BuildMetrics.WorkerMetrics: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    10: .standard(proto: "worker_status"),
    12: .same(proto: "code"),
    11: .standard(proto: "actions_executed"),
    13: .standard(proto: "prior_actions_executed"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 10: try { try decoder.decodeSingularEnumField(value: &self.workerStatus) }()
      case 11: try { try decoder.decodeSingularInt64Field(value: &self.actionsExecuted) }()
      case 12: try { try decoder.decodeSingularEnumField(value: &self._code) }()
      case 13: try { try decoder.decodeSingularInt64Field(value: &self.priorActionsExecuted) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.workerStatus != .notStarted {
      try visitor.visitSingularEnumField(value: self.workerStatus, fieldNumber: 10)
    }
    if self.actionsExecuted != 0 {
      try visitor.visitSingularInt64Field(value: self.actionsExecuted, fieldNumber: 11)
    }
    try { if let v = self._code {
      try visitor.visitSingularEnumField(value: v, fieldNumber: 12)
    } }()
    if self.priorActionsExecuted != 0 {
      try visitor.visitSingularInt64Field(value: self.priorActionsExecuted, fieldNumber: 13)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: BuildEventStream_BuildMetrics.WorkerMetrics, rhs: BuildEventStream_BuildMetrics.WorkerMetrics) -> Bool {
    ...
    if lhs.actionsExecuted != rhs.actionsExecuted {return false}
    if lhs.priorActionsExecuted != rhs.priorActionsExecuted {return false}
...
extension BuildEventStream_BuildMetrics.WorkerMetrics.WorkerStatus: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "NOT_STARTED"),
    1: .same(proto: "ALIVE"),
    2: .same(proto: "KILLED_DUE_TO_MEMORY_PRESSURE"),
    3: .same(proto: "KILLED_UNKNOWN"),
    4: .same(proto: "KILLED_DUE_TO_INTERRUPTED_EXCEPTION"),
    5: .same(proto: "KILLED_DUE_TO_IO_EXCEPTION"),
    6: .same(proto: "KILLED_DUE_TO_USER_EXEC_EXCEPTION"),
  ]
}
...
extension BuildEventStream_BuildMetrics.WorkerMetrics.WorkerStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    4: .standard(proto: "prior_worker_memory_in_kb"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.priorWorkerMemoryInKb) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.priorWorkerMemoryInKb != 0 {
      try visitor.visitSingularInt32Field(value: self.priorWorkerMemoryInKb, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: BuildEventStream_BuildMetrics.WorkerMetrics.WorkerStats, rhs: BuildEventStream_BuildMetrics.WorkerMetrics.WorkerStats) -> Bool {
    ...
    if lhs.priorWorkerMemoryInKb != rhs.priorWorkerMemoryInKb {return false}
...
extension BuildEventStream_BuildMetrics.WorkerPoolMetrics.WorkerPoolStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    6: .standard(proto: "user_exec_exception_destroyed_count"),
    7: .standard(proto: "io_exception_destroyed_count"),
    8: .standard(proto: "interrupted_exception_destroyed_count"),
    9: .standard(proto: "unknown_destroyed_count"),
    10: .standard(proto: "alive_count"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeSingularInt64Field(value: &self.userExecExceptionDestroyedCount) }()
      case 7: try { try decoder.decodeSingularInt64Field(value: &self.ioExceptionDestroyedCount) }()
      case 8: try { try decoder.decodeSingularInt64Field(value: &self.interruptedExceptionDestroyedCount) }()
      case 9: try { try decoder.decodeSingularInt64Field(value: &self.unknownDestroyedCount) }()
      case 10: try { try decoder.decodeSingularInt64Field(value: &self.aliveCount) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.userExecExceptionDestroyedCount != 0 {
      try visitor.visitSingularInt64Field(value: self.userExecExceptionDestroyedCount, fieldNumber: 6)
    }
    if self.ioExceptionDestroyedCount != 0 {
      try visitor.visitSingularInt64Field(value: self.ioExceptionDestroyedCount, fieldNumber: 7)
    }
    if self.interruptedExceptionDestroyedCount != 0 {
      try visitor.visitSingularInt64Field(value: self.interruptedExceptionDestroyedCount, fieldNumber: 8)
    }
    if self.unknownDestroyedCount != 0 {
      try visitor.visitSingularInt64Field(value: self.unknownDestroyedCount, fieldNumber: 9)
    }
    if self.aliveCount != 0 {
      try visitor.visitSingularInt64Field(value: self.aliveCount, fieldNumber: 10)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: BuildEventStream_BuildMetrics.WorkerPoolMetrics.WorkerPoolStats, rhs: BuildEventStream_BuildMetrics.WorkerPoolMetrics.WorkerPoolStats) -> Bool {
    ...
    if lhs.userExecExceptionDestroyedCount != rhs.userExecExceptionDestroyedCount {return false}
    if lhs.ioExceptionDestroyedCount != rhs.ioExceptionDestroyedCount {return false}
    if lhs.interruptedExceptionDestroyedCount != rhs.interruptedExceptionDestroyedCount {return false}
    if lhs.unknownDestroyedCount != rhs.unknownDestroyedCount {return false}
    if lhs.aliveCount != rhs.aliveCount {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension BuildEventStream_BuildMetrics.DynamicExecutionMetrics: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = BuildEventStream_BuildMetrics.protoMessageName + ".DynamicExecutionMetrics"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "race_statistics"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.raceStatistics) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.raceStatistics.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.raceStatistics, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: BuildEventStream_BuildMetrics.DynamicExecutionMetrics, rhs: BuildEventStream_BuildMetrics.DynamicExecutionMetrics) -> Bool {
    if lhs.raceStatistics != rhs.raceStatistics {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension BuildEventStream_BuildMetrics.DynamicExecutionMetrics.RaceStatistics: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = BuildEventStream_BuildMetrics.DynamicExecutionMetrics.protoMessageName + ".RaceStatistics"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "mnemonic"),
    2: .standard(proto: "local_runner"),
    3: .standard(proto: "remote_runner"),
    4: .standard(proto: "local_wins"),
    5: .standard(proto: "remote_wins"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.mnemonic) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.localRunner) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.remoteRunner) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.localWins) }()
      case 5: try { try decoder.decodeSingularInt32Field(value: &self.remoteWins) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.localRunner.isEmpty {
      try visitor.visitSingularStringField(value: self.localRunner, fieldNumber: 2)
    }
    if !self.remoteRunner.isEmpty {
      try visitor.visitSingularStringField(value: self.remoteRunner, fieldNumber: 3)
    }
    if self.localWins != 0 {
      try visitor.visitSingularInt32Field(value: self.localWins, fieldNumber: 4)
    }
    if self.remoteWins != 0 {
      try visitor.visitSingularInt32Field(value: self.remoteWins, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: BuildEventStream_BuildMetrics.DynamicExecutionMetrics.RaceStatistics, rhs: BuildEventStream_BuildMetrics.DynamicExecutionMetrics.RaceStatistics) -> Bool {
    if lhs.mnemonic != rhs.mnemonic {return false}
    if lhs.localRunner != rhs.localRunner {return false}
    if lhs.remoteRunner != rhs.remoteRunner {return false}
    if lhs.localWins != rhs.localWins {return false}
    if lhs.remoteWins != rhs.remoteWins {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
