...
/// Docs in java enum.
public enum Options_OptionEffectTag: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [Options_OptionEffectTag] = [
    .unknown,
    .noOp,
...
/// Docs in java enum.
public enum Options_OptionMetadataTag: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case experimental // = 0
  ...
  public var rawValue: Int {
    ...
    case .immutable: return 7
    case .UNRECOGNIZED(let i): return i
    }
  }

  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Options_OptionMetadataTag] = [
    .experimental,
    .incompatibleChange,
    .deprecated,
    .hidden,
