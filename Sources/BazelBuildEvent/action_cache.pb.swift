...
public struct Blaze_ActionCacheStatistics: Sendable {
  ...
  public var loadTimeInMs: UInt64 = 0

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  /// Reasons for not finding an action in the cache.
  public enum MissReason: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Blaze_ActionCacheStatistics.MissReason] = [
      .differentActionKey,
      .differentDeps,
  ...
  public struct MissDetail: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Blaze_ActionCacheStatistics: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    6: .standard(proto: "load_time_in_ms"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeSingularUInt64Field(value: &self.loadTimeInMs) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.loadTimeInMs != 0 {
      try visitor.visitSingularUInt64Field(value: self.loadTimeInMs, fieldNumber: 6)
    }
  ...
  public static func ==(lhs: Blaze_ActionCacheStatistics, rhs: Blaze_ActionCacheStatistics) -> Bool {
    ...
    if lhs.loadTimeInMs != rhs.loadTimeInMs {return false}
